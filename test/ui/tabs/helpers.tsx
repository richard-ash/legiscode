...
import { buildSessionBillsById, buildTitleMap, TabStrip } from "@/ui/tabs/tab-strip";
...
const PENDING_BILLS_BY_ID = buildSessionBillsById([]);
...
export function TabHost({ initial, onState }: TabHostProps) {
  ...
  return (
    <TabStrip
      ...
      titleMap={TITLE_MAP}
      sessionBillsById={PENDING_BILLS_BY_ID}
      closeAt={close}
